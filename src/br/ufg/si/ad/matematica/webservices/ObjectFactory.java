 ...
 * generated in the br.ufg.si.ad.matematica.webservices package. 
...
public class ObjectFactory {
    ...
    private final static QName _Subtrair_QNAME = new QName("http://operacoes.matematica.ad.si.ufg.br/", "subtrair");
    private final static QName _SubtrairResponse_QNAME = new QName("http://operacoes.matematica.ad.si.ufg.br/", "subtrairResponse");
    private final static QName _Multiplicar_QNAME = new QName("http://operacoes.matematica.ad.si.ufg.br/", "multiplicar");
    private final static QName _Dividir_QNAME = new QName("http://operacoes.matematica.ad.si.ufg.br/", "dividir");
    private final static QName _DividirResponse_QNAME = new QName("http://operacoes.matematica.ad.si.ufg.br/", "dividirResponse");
    private final static QName _Somar_QNAME = new QName("http://operacoes.matematica.ad.si.ufg.br/", "somar");
    private final static QName _MultiplicarResponse_QNAME = new QName("http://operacoes.matematica.ad.si.ufg.br/", "multiplicarResponse");
    private final static QName _SomarResponse_QNAME = new QName("http://operacoes.matematica.ad.si.ufg.br/", "somarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.ufg.si.ad.matematica.webservices
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operacoes.matematica.ad.si.ufg.br/", name = "subtrair")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operacoes.matematica.ad.si.ufg.br/", name = "subtrairResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operacoes.matematica.ad.si.ufg.br/", name = "multiplicar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operacoes.matematica.ad.si.ufg.br/", name = "dividir")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operacoes.matematica.ad.si.ufg.br/", name = "dividirResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operacoes.matematica.ad.si.ufg.br/", name = "somar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operacoes.matematica.ad.si.ufg.br/", name = "multiplicarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://operacoes.matematica.ad.si.ufg.br/", name = "somarResponse")
